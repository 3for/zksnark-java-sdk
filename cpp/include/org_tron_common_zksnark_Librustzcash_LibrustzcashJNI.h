...
#include <jni.h>
/* Header for class org_tron_common_zksnark_Librustzcash_LibrustzcashJNI */

#ifndef _Included_org_tron_common_zksnark_Librustzcash_LibrustzcashJNI
#define _Included_org_tron_common_zksnark_Librustzcash_LibrustzcashJNI
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 * Signature: (JJ[B[B[B[B[BJ[B[B[B[B[B)Z
 */
JNIEXPORT jboolean JNICALL Java_org_tron_common_zksnark_Librustzcash_00024LibrustzcashJNI_librustzcashSaplingSpendProof
  (JNIEnv *, jobject, jlong, jlong, jbyteArray, jbyteArray, jbyteArray, jbyteArray, jbyteArray, jlong, jbyteArray, jbyteArray, jbyteArray, jbyteArray, jbyteArray);

/*
 * Class:     org_tron_common_zksnark_Librustzcash_LibrustzcashJNI
 * Method:    librustzcashSaplingOutputProof
 * Signature: (JJ[B[B[B[BJ[B[B)Z
 */
JNIEXPORT jboolean JNICALL Java_org_tron_common_zksnark_Librustzcash_00024LibrustzcashJNI_librustzcashSaplingOutputProof
  (JNIEnv *, jobject, jlong, jlong, jbyteArray, jbyteArray, jbyteArray, jbyteArray, jlong, jbyteArray, jbyteArray);
